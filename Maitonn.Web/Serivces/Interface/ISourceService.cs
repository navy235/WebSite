...
namespace Maitonn.Web
{
    public interface ISourceService
    {
        ...
        List<HttpLinkItem> GetSuggestMedia(int province, int take, int PCategoryCode = 0, int CategoryCode = 0);
        ...
        List<HttpLinkItem> GetSuggestCompany(int province, int take, int PCategoryCode = 0, int CategoryCode = 0);
