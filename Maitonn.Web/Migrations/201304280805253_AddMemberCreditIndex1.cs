namespace Maitonn.Web.Migrations
{
    ...
    public partial class AddMemberCreditIndex1 : DbMigration
    {
        ...
        {
            DropIndex("dbo.Member_CreditIndex", new[] { "MemberID" });
            DropIndex("dbo.OutDoor", new[] { "MemberID" });
            DropForeignKey("dbo.Member_CreditIndex", "MemberID", "dbo.Member");
